...
/**TODO: REWRITE CODE TO USE BASE INDEX MAYBE
 * Replace Index Construction: Instead of building the inverted index directly within the BSBI_Index constructor, you can create an instance of the Index class and pass the directory path and block size as parameters to its constructor. This will handle the construction of the inverted index.
 *
 * Retrieving Index and Statistics: You can retrieve the inverted index and statistics (elapsed time, number of files indexed, total file size indexed) from the Index object after it has been constructed. These values can be obtained using getter methods provided by the Index class.
 *
 * Updating Statistics File Path: If necessary, you can update the statistics file path within the Index class to match the desired location.
 *
 * Printing Index and Statistics: You can remove the methods for printing the index and statistics from the BSBI_Index class since these functionalities are already present in the Index class.
 *
 * Opening .txt Files: The openTXT method can remain in the BSBI_Index class if it serves a specific purpose unrelated to the inverted index itself.*/

/**TODO: write better comments for methods*/

/**Practice 5 BSBI Index*/
public class BSBI_Index {
    ...
    public void writeStatisticsToFile() {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter(filePath))) {
            writer.println("Time taken to complete BSBI: " + elapsedTime + " ns,\nor " + elapsedTime / 1_000_000.0 + " ms,\nor " + elapsedTime / 1_000_000_000.0 + " s.");
    ...
    public void printStatistics() {
        System.out.println("Time taken to complete BSBI: " + elapsedTime + " ns,\nor " + elapsedTime / 1_000_000.0 + " ms,\nor " + elapsedTime / 1_000_000_000.0 + " s.\nNumber of files indexed: " + numFilesIndexed +"\nTotal file size indexed: " + totalFileSize + " KB");
    }
